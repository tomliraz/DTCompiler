...
// Enter 100 200 100
	...
	/*
	 * Import Tests Series of tests that checks for imports; you must manually check
	 * by looking at your generated code.
	 */
	...
	// must import edu.ufl.cise.plc.runtime.ImageOps if using the
	// binaryImageScalarOp function
	...
	// must import edu.ufl.cise.plc.runtime.ImageOps if using the setColor function
	// when initializing image
	// must import edu.ufl.cise.plc.runtime.ColorTuple when converting colorfloat to
	// color
	// must import edu.ufl.cise.plc.runtime.ColorTupleFloat for the expression
	// assigned to image
	...
	@Test
	// hint: input
	// https://upload.wikimedia.org/wikipedia/commons/9/92/Albert_and_Alberta.jpg in
	// console for code to work
	...
	/*
	 * Unsuccessful Tests List of tests that must give exceptions
	 */
	...
	// second program must give a ClassCastException or a TypeCheckException
	// (depending on how your TypeCheckVisitor works)
